...
chance = 1000000 # Probabilty factor to control how often the simulation performs any given actions
...
while True:
    time = datetime.today()
    if time.minute in random.choices(range(0,60), k=5):  # A way to control the probability
        # Register user
        try:
            if random.uniform(0, chance) < 0.01: # A way to control the probability
        ...
        # Rent
        try:
            if random.uniform(0, chance) < 0.5: # A way to control the probability
        ...
        # Return
        try:
            if random.uniform(0, chance) < 0.1: # A way to control the probability
        ...
        # Payment
        try:
            if random.uniform(0, chance) < 0.3: # A way to control the probability
        ...
        # Report
        try:
            if random.uniform(0, chance) < 0.05: # A way to control the probability
        ...
        # Move bike
        try:
            if random.uniform(0, chance) < 0.15: # A way to control the probability
